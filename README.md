...
To install the bleeding edge version generated by `gnext` run:

```bash
curl -L https://github.com/alexknuckles/termux-scripts/releases/download/next/installer.sh | bash -s -- -r
```
